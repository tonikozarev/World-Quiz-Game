...
enum class AchievementId(
  ...
  DiamondWorld(AchievementSector.World, "Diamond World", "\uD83D\uDC8E", "Complete all countries and capitals perfectly in one quiz."),
  HardcoreCountriesLegend(AchievementSector.World, "Hardcore Countries Legend", "\uD83E\uDDE0", "Perfectly clear Hardcore Countries with all question variants selected."),
  HardcoreCapitalsLegend(AchievementSector.World, "Hardcore Capitals Legend", "\uD83E\uDDE0", "Perfectly clear Hardcore Capitals with all question variants selected."),
  HardcoreLegend(AchievementSector.World, "Hardcore Legend", "\uD83E\uDDE0", "Perfectly clear Hardcore with countries, capitals, and all question variants selected."),
  WorldPurist(AchievementSector.World, "World Purist", "\uD83C\uDF10", "Complete all countries and capitals perfectly without using any hints."),
