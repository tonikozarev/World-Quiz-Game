...
class TestingInactiveIconReceiver : BroadcastReceiver() {
  override fun onReceive(
    ...
    EngagementDebugLogger.info(
      "TestingInactiveIconReceiver fired at ${EngagementDebugLogger.formatEpoch(System.currentTimeMillis())}.",
    )
    AppGraph.from(context.applicationContext)
      .engagementCoordinator
      .setInactiveLauncherIcon(active = true, persist = true)
  }
}
